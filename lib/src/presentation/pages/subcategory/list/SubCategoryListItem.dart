...
class SubCategoryListItem extends StatelessWidget {
  final SubCategoryListBloc? bloc;
  ...
  Widget build(BuildContext context) {
    ...
    final hasDescription = (subCategory.descripcion ?? '').trim().isNotEmpty;
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        hasDescription
                            ? subCategory.descripcion!.trim()
                            : 'Subcategoria lista para editar y organizar productos.',
                        maxLines: 2,
                        overflow: TextOverflow.ellipsis,
                ...
                Column(
                  children: [
                      ...
                      child: IconButton(
                        onPressed: () {
                          selectConfirmDialog(
                            context,
                            () => bloc?.add(
                              DeleteSubCategoryListEvent(id: subCategory.id),
                            ),
                          );
                        },
                    ...
                    const SizedBox(height: 10),
                    _StatusChip(isActive: subCategory.isActive),
                  ],
                ),
              ],
            ),
